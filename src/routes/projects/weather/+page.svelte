<script lang="ts">
	...
	const project = projectDetails.weather;
</script>
...
>
	<ProjectHero
		...
		subtitle="A responsive weather dashboard with location-based forecasts and interactive data visualization"
	...
	<LessonsLearned lessons={project.lessons} />
</ProjectContent>
